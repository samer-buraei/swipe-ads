...
function SearchContent() {
    ...
    const categoryName = categoryId
        ? categories?.find((c: any) => c.id === categoryId)?.name ?? 'Pretraga'
        : 'Pretraga'
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <div className="px-4 pt-3 pb-2">
                <p className="text-lg font-bold text-gray-900">{categoryName}</p>
            </div>
            ...
            <div className="flex justify-center px-4 pb-3">
                <div className="flex bg-gray-100 rounded-full p-1">
                    <button
                        ...
                        className={`px-6 py-1.5 rounded-full text-sm font-medium transition-all ${viewMode === 'list'
                    ...
                    <button
                        ...
                        className={`px-6 py-1.5 rounded-full text-sm font-medium transition-all ${viewMode === 'swipe'
                            ? 'bg-[#1B3D7E] text-white shadow-sm'
                            : 'text-gray-500'
                            }`}
                    >
                        Swipe
            ...
            {/* Search bar + filters (only in list mode) */}
            {viewMode === 'list' && (
            ...
            {viewMode === 'swipe' ? (
                <div className="px-4">
                    {isLoading ? (
                        ...
                        <SwipeDeck initialCards={results.items} />
                    ) : (
